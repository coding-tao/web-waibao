<template>
    <div class="container">
       ...
       <div class="main">
            <div class="title">
                <span><i>*</i>职位名称：</span>
                <el-input v-model="title" placeholder="请输入内容" class="input-text" :maxlength='10'></el-input>
            </div>
            <div class="content-edit">
                <p class="edit-title">*招聘要求:</p>
                <div id="summernote"></div>
            </div>
            <div class="btns">
                <el-button size="small" type="primary" @click="handleSave">确定</el-button>
                <el-button size="mini"  class="link" type="info">
                    <router-link to="/recruitList" style="color: #fff;">返回</router-link>
                </el-button>
            </div>
        </div>
